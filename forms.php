     ...
     <form action="" method="POST" id="loginForm">
            <div class="account-block">
                ...
                <label for="emailLogin">Email*</label>
                        <input type="email" id="emailLogin" name="emailLogin" class="input" placeholder="Exemplo: email@gmail.com" required>
                <br>
                <label for="senhaLogin">Senha*</label>
                <input type="password" id="senhaLogin" name="senhaLogin" class="input" placeholder="Exemplo: 123456" required>
            ...
            <div class="container">
                ...
                <form action="" method="POST" id="registrarForm">
                    <fieldset>
                        ...
                        <input type="text" id="nameReg" name="nameReg" class="input" placeholder="Exemplo: Caio Trevisani" autofocus required>
                        <label for="emailReg">Email*</label>
                        <input type="email" id="emailReg" name="emailReg" class="input" placeholder="Exemplo: email@gmail.com" required>
                        ...
                        <input type="tel" id="telefoneReg" oninput=mascara_telefone() name="telefoneReg" class="input" required maxlength="14">
                        <label for="cepReg">Cep*</label>
                        <input type="text" id="cepReg" name="cepReg" class="input" oninput=mascara_cep() required maxlength="10">
